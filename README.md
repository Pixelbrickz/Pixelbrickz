...
$\texttt{\color{#}  }$
$\texttt{\color{#} BEST VIEWED IN DARK MODE(S) BTW SORRY!! ( fyi my rentry wasn't made for mobile aa.. ) }$

<img width="63%" src="https://github.com/user-attachments/assets/8a77f54b-cd3e-4144-933f-a9d2269c5f41" />

$\texttt{\color{#} " Let's}$ $\texttt{\color{#} bash}$ $\texttt{\color{#} some}$ $\texttt{\color{#} heads!}$ $\texttt{\color{#}" }$

$\texttt{\color{#}" On}$ $\texttt{\color{#} it!}$ $\texttt{\color{#} " }$
...
$\texttt{\color{#dbb9ac}WIP !  !   }$
   ...
   $\texttt{\color{#dbb9ac} pixel }$ $\texttt{\color{#844d6d}/}$ $\texttt{\color{#b18994}euni}$ $\texttt{\color{#dbb9ac}(}$[+](https://pronouns.cc/@pixelbrickz)$\texttt{\color{#dbb9ac})}$ $\texttt{\color{#b18994}!}$
